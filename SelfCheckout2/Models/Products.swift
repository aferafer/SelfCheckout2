...
struct Products: Hashable {
    ...
    enum customOptions {
        ...
        case subVariation //product is set to this setting when it is a variation and only to be displayed when the search bar is active
    }
...
extension Products {
    ...
    [
        ...
        Products(displayTitle: "Not A Pefect Leaf Beet Greens", cartName: "Not A Pefect Leaf Beet Greens", referenceName: "Holey_Beetgreens", searchName: "beet greens", pic: "holey_beet_greens", catagory: productCatagory.produce, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Red Cabbage", cartName: "Red Cabbage Bag", referenceName: "Red_Cabbage", searchName: "cabbage red", pic: "red_cabbage", catagory: productCatagory.produce, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Cherry Tomatoes", cartName: "Cherry Tomato Basket", referenceName: "Cherry_Tomatoes", searchName: "cherry tomatoes", pic: "cherry", catagory: productCatagory.produce, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Green Onions", cartName: "Green Onion Bunch", referenceName: "Green_Onions", searchName: "green onions", pic: "green_onions", catagory: productCatagory.produce, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Colored Peppers", cartName: "Colored Pepper", referenceName: "Colored_Peppers", searchName: "peppers colored", pic: "colored_peppers", catagory: productCatagory.produce, options: customOptions.subVariation),
        ...
        Products(displayTitle: "Green Peppers", cartName: "Green Pepper", referenceName: "Green_Peppers", searchName: "peppers green", pic: "green_peppers", catagory: productCatagory.produce, options: customOptions.subVariation),
        ...
        Products(displayTitle: "Red & Green Bag", cartName: "Red & Green Headlettuce", referenceName: "RedGreen_Headlettuce", searchName: "lettuce headlettuce bag", pic: "red&green_head_lettuce", catagory: productCatagory.produce, options: customOptions.noOptions),
        Products(displayTitle: "Romaine Lettuce", cartName: "Romaine Lettuce Bag", referenceName: "Romaine_Lettuce", searchName: "lettuce romaine", pic: "romaine_lettuce", catagory: productCatagory.produce, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Spinach", cartName: "Spinach Bag", referenceName: "Spinach", searchName: "spinach", pic: "spinach", catagory: productCatagory.produce, options: customOptions.noOptions),
        Products(displayTitle: "Not a Perfect Leaf Spinach", cartName: "Not a Perfect Leaf Spinach", referenceName: "Holey_Spinach", searchName: "spinach", pic: "holey_spinach", catagory: productCatagory.produce, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Swiss Chard", cartName: "Swiss Chard Bunch", referenceName: "Swiss_Chard", searchName: "swiss chard", pic: "swiss_chard", catagory: productCatagory.produce, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Yellow Heirloom Bag", cartName: "Yellow Heirloom Tomatoes", referenceName: "Yellow_Heirloom", searchName: "tomatoes yellow heirloom", pic: "yellow_heirloom_bag", catagory: productCatagory.produce, options: customOptions.subVariation),
        Products(displayTitle: "Beefsteak Bag", cartName: "Beefsteak Tomato Bag", referenceName: "Beefsteak_Bag", searchName: "tomatoes beefsteak", pic: "beefsteak_bag", catagory: productCatagory.produce, options: customOptions.subVariation),
        Products(displayTitle: "Beefsteak Basket", cartName: "Beefsteak Tomato Basket", referenceName: "Beefsteak_Basket", searchName: "tomatoes beefsteak", pic: "beefsteak_basket", catagory: productCatagory.produce, options: customOptions.subVariation),
        ...
        Products(displayTitle: "Garlic Scape Butter", cartName: "Garlic Scape Butter", referenceName: "Garlic_Scape_Butter", searchName: "garlic scape butter", pic: "garlic_scape_butter", catagory: productCatagory.preparedFoods, options: customOptions.uniquePrice),
        ...
        Products(displayTitle: "Pot Pie", cartName: "Pot Pie", referenceName: "Turkey_Pot_Pie", searchName: "pot pie", pic: "turkey_pot_pie", catagory: productCatagory.preparedFoods, options: customOptions.noOptions),
